...
heading=Label(root,text="ALL TASK",font="ariel 20 bold",fg="white",bg="#32405b")
...
button=Button(frame,text="ADD",font="ariel 20 bold",width=6,bg="#5a59ff",fg="#fff",bd=0,command=addTask)
button.place(x=300,y=0)

#listbox
frame1=Frame(root,bd=3,width=700,height=200,bg="#32405b")
frame1.pack(pady=(160,0))
listbox = Listbox(frame1,font=('arial',12),width=40,height=16,bg="#32405b",fg="white",cursor="hand2",selectbackground="#5a59ff")
